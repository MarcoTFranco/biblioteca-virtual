...
@Component
public class SomenteODonoDoEmprestimoPodeDevolverValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (!usuario.temEmprestimo(emprestimo)) {
            errors.rejectValue("idEmprestimo", null, "Este empréstimo não pertence a este usuário");
        }
